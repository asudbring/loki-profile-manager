...
- Fixed skill validation for Markdown references with optional titles, such as image links using `path "title"`; missing or escaping relative reference assets now warn instead of blocking migration.
